...
<!-- Mirrored from www.pixelwibes.com/template/ebazar/html/dist/ui-elements/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Jan 2022 09:40:03 GMT -->
<head>
    <meta charset="utf-8">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center border-0 rounded-lg auth-h100">
                        <div class="w-100 p-3 p-md-5 card border-0 shadow-sm" style="max-width: 32rem;">
                            ...
                            {{-- <form class="row g-1 p-3 p-md-4"> --}}
                                <form method="POST" class="user row g-1 p-3 p-md-4" action="{{ route('register') }}">
                                    @csrf
                                ...
                                <div class="col-12 text-center mt-4">
                                    <span>Already have an account? 
                                        <a href="auth-signin.html" title="Sign in" class="text-secondary">Sign in here</a>
                                    </span>
                                </div>
                            </form>
                            <!-- End Form -->
